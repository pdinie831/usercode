...
process.BcAnalysis = cms.EDAnalyzer('BcAnalysis',
                              inputDouble_     = cms.vstring ("cut_Pt_Mu=3.5",##tagli che posso cambiare
            		        	        	      "cut_Pt_Trk=0.9", 	    #1 not used 
            		      		        	      "cut_chi2n=3",
    	    		      		        	      "cut_cl=0.001",   	     #0.01 
    	    		      		        	      "cut_cl_Jpsi=0.1",   	     #0.01 
                							      "cut_cl_Bc=0.001",
    	    		      		        	      "cut_eta=2.2",
     	    		      		        	      "cut_eta_pi=2.4",
    	    		      		        	      "cut_nhits=6",
                              ...
                              inputString_     = cms.vstring ("filename=" + output,
							                      "HLTname1=HLT_DoubleMu3p5_Jpsi_Displaced_v2",
							                      "HLTname2=HLT_DoubleMu3p5_Jpsi_Displaced_v2",                                                            
						                 	      "HLTname3=HLT_DoubleMu3p5_Jpsi_Displaced_v2",                                                            
							      				  "HLTMatchName=hltTriggerSummaryAOD",
 							      				  "HLTMatchModule1=hltDoubleMu3p5JpsiDisplacedL3Filtered",
							      				  "HLTMatchModule2=hltDisplacedmumuFilterDoubleMu3p5Jpsi",
