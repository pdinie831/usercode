//
// File generated by rootcint at Thu Oct 17 21:54:40 2013
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::BcTreeCand*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("BcTreeCand", ::BcTreeCand::Class_Version(), "./../interface/BcTree.h", 16,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::BcTreeGENCand*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("BcTreeGENCand", ::BcTreeGENCand::Class_Version(), "./../interface/BcTree.h", 154,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::JpsiCand*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("JpsiCand", ::JpsiCand::Class_Version(), "./../interface/BcTree.h", 230,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::BcTreeHeader*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("BcTreeHeader", ::BcTreeHeader::Class_Version(), "./../interface/BcTree.h", 282,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::BcTree*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("BcTree", ::BcTree::Class_Version(), "./../interface/BcTree.h", 328,
...
void BcTreeCand::Streamer(TBuffer &R__b)
{
   ...
   if (R__b.IsReading()) {
      ...
      R__b.ReadStaticArray((double*)Ris_);
      R__b >> El_;
      R__b >> Els_;
      R__b >> Cos_;
      R__b >> ClS_;
      ...
      R__b.ReadStaticArray((double*)IP3D_);
      R__b.ReadStaticArray((double*)IPbs_);
      R__b.ReadStaticArray((double*)sIP3D_);
      R__b.ReadStaticArray((double*)sIPbs_);
      R__b.ReadStaticArray((double*)MatchMu_);
      R__b.ReadStaticArray((double*)MatchPi1_);
      R__b.ReadStaticArray((double*)MatchPi2_);
      R__b.ReadStaticArray((double*)MatchPi3_);
      R__b.ReadStaticArray((int*)PiCh_);
      R__b.ReadStaticArray((int*)MuCh_);
      R__b >> ElsigJpsi_;
      R__b >> CosJpsi_;
      R__b.ReadStaticArray((int*)TrkNHits_);
      R__b.ReadStaticArray((int*)TrkPixelHits_);
      R__b.ReadStaticArray((float*)TrkChi2_);
      ...
      R__b.WriteArray(IP3D_, 3);
      R__b.WriteArray(IPbs_, 3);
      R__b.WriteArray(sIP3D_, 3);
      R__b.WriteArray(sIPbs_, 3);
      R__b.WriteArray(MatchMu_, 2);
      R__b.WriteArray(MatchPi1_, 2);
      R__b.WriteArray(MatchPi2_, 2);
      R__b.WriteArray(MatchPi3_, 2);
      R__b.WriteArray(PiCh_, 3);
      R__b.WriteArray(MuCh_, 2);
      R__b << ElsigJpsi_;
      R__b << CosJpsi_;
      R__b.WriteArray(TrkNHits_, 3);
      R__b.WriteArray(TrkPixelHits_, 3);
      R__b.WriteArray(TrkChi2_, 3);
...
void BcTreeCand::ShowMembers(TMemberInspector &R__insp)
{
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "Bc3Pi_", &Bc3Pi_);
      R__insp.InspectMember(Bc3Pi_, "Bc3Pi_.");
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "Pi1_", &Pi1_);
      R__insp.InspectMember(Pi1_, "Pi1_.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "Pi2_", &Pi2_);
      R__insp.InspectMember(Pi2_, "Pi2_.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "Pi3_", &Pi3_);
      R__insp.InspectMember(Pi3_, "Pi3_.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "tPi1_", &tPi1_);
      R__insp.InspectMember(tPi1_, "tPi1_.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "tPi2_", &tPi2_);
      R__insp.InspectMember(tPi2_, "tPi2_.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "tPi3_", &tPi3_);
      R__insp.InspectMember(tPi3_, "tPi3_.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "JpsiV_", &JpsiV_);
      R__insp.InspectMember(JpsiV_, "JpsiV_.");
      R__insp.Inspect(R__cl, R__insp.GetParent(), "Ris_[5]", Ris_);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "IP3D_[3]", IP3D_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "IPbs_[3]", IPbs_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "sIP3D_[3]", sIP3D_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "sIPbs_[3]", sIPbs_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "MatchMu_[2]", MatchMu_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "MatchPi1_[2]", MatchPi1_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "MatchPi2_[2]", MatchPi2_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "MatchPi3_[2]", MatchPi3_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "PiCh_[3]", PiCh_);
      ...
      R__insp.Inspect(R__cl, R__insp.GetParent(), "TrkNHits_[3]", TrkNHits_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "TrkPixelHits_[3]", TrkPixelHits_);
      R__insp.Inspect(R__cl, R__insp.GetParent(), "TrkChi2_[3]", TrkChi2_);
...
, *(TLorentzVector*) libp->para[10].ref, (Double_t*) G__int(libp->para[11])
...
, (Double_t) G__double(libp->para[16]), (Double_t*) G__int(libp->para[17])
, (Double_t*) G__int(libp->para[18]), (Double_t*) G__int(libp->para[19])
, (Double_t*) G__int(libp->para[20]), (Double_t*) G__int(libp->para[21])
, (Double_t*) G__int(libp->para[22]), (Double_t*) G__int(libp->para[23])
, (Double_t*) G__int(libp->para[24]), (Double_t*) G__int(libp->para[25])
, (Double_t*) G__int(libp->para[26]), (Double_t*) G__int(libp->para[27])
, (Double_t*) G__int(libp->para[28]), (Int_t*) G__int(libp->para[29])
, (Int_t*) G__int(libp->para[30]), (Double_t) G__double(libp->para[31])
, (Double_t) G__double(libp->para[32]), (Int_t*) G__int(libp->para[33])
, (Int_t*) G__int(libp->para[34]), (Float_t*) G__int(libp->para[35])
, (Double_t*) G__int(libp->para[36]));
   } else {
     p = new((void*) gvp) BcTreeCand(
*(TLorentzVector*) libp->para[0].ref, *(TLorentzVector*) libp->para[1].ref
, *(TLorentzVector*) libp->para[2].ref, *(TLorentzVector*) libp->para[3].ref
...
{
      G__letint(result7, 85, (long) ((BcTreeCand*) G__getstructoffset())->GetBc3Pi());
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letdouble(result7, 100, (double) ((BcTreeCand*) G__getstructoffset())->GetRis((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BcTreeCand*) G__getstructoffset())->GetEl());
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letdouble(result7, 100, (double) ((BcTreeCand*) G__getstructoffset())->GetIP3D((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BcTreeCand*) G__getstructoffset())->GetIPbs((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BcTreeCand*) G__getstructoffset())->GetsIP3D((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BcTreeCand*) G__getstructoffset())->GetsIPbs((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      G__letdouble(result7, 100, (double) ((BcTreeCand*) G__getstructoffset())->GetMatchPi1((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BcTreeCand*) G__getstructoffset())->GetMatchPi2((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BcTreeCand*) G__getstructoffset())->GetMatchPi3((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_33(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((BcTreeCand*) G__getstructoffset())->GetPiCh((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BcTreeDictionary_526_0_37(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((BcTreeCand*) G__getstructoffset())->GetTrkNHits((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_38(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((BcTreeCand*) G__getstructoffset())->GetTrkPixelHIts((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_39(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 102, (double) ((BcTreeCand*) G__getstructoffset())->GetTrkChi2((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BcTreeDictionary_526_0_48(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BcTreeDictionary_526_0_49(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BcTreeCand::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_50(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) BcTreeCand::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_51(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BcTreeCand::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_526_0_52(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BcTreeDictionary_526_0_53(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__BcTreeDictionary_526_0_54(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetBc3Pi(*((TLorentzVector*) G__int(libp->para[0])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetPi1(*((TLorentzVector*) G__int(libp->para[0])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetPi2(*((TLorentzVector*) G__int(libp->para[0])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetPi3(*((TLorentzVector*) G__int(libp->para[0])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetRis0((Double_t) G__double(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetRis1((Double_t) G__double(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetRis2((Double_t) G__double(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetRis3((Double_t) G__double(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetRis4((Double_t) G__double(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetPiCh1((Int_t) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetPiCh2((Int_t) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
{
      ((BcTreeGENCand*) G__getstructoffset())->SetPiCh3((Int_t) G__int(libp->para[0]));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BcTreeDictionary_527_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TLorentzVector* pobj;
         TLorentzVector xobj = ((BcTreeGENCand*) G__getstructoffset())->GetBc3Pi();
...
static int G__BcTreeDictionary_527_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TLorentzVector* pobj;
         TLorentzVector xobj = ((BcTreeGENCand*) G__getstructoffset())->GetPi1();
         pobj = new TLorentzVector(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__BcTreeDictionary_527_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TLorentzVector* pobj;
         TLorentzVector xobj = ((BcTreeGENCand*) G__getstructoffset())->GetPi2();
         pobj = new TLorentzVector(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__BcTreeDictionary_527_0_33(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         TLorentzVector* pobj;
         TLorentzVector xobj = ((BcTreeGENCand*) G__getstructoffset())->GetPi3();
         pobj = new TLorentzVector(xobj);
         result7->obj.i = (long) ((void*) pobj);
         result7->ref = result7->obj.i;
         G__store_tempobject(*result7);
...
static int G__BcTreeDictionary_527_0_34(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((BcTreeGENCand*) G__getstructoffset())->GetEl());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_527_0_35(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
{
      G__letdouble(result7, 100, (double) ((BcTreeGENCand*) G__getstructoffset())->GetRis((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_527_0_39(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((BcTreeGENCand*) G__getstructoffset())->GetPiCh((Int_t) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__BcTreeDictionary_527_0_44(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BcTreeDictionary_527_0_48(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BcTreeDictionary_527_0_49(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BcTreeGENCand::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_527_0_50(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) BcTreeGENCand::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_527_0_51(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) BcTreeGENCand::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__BcTreeDictionary_527_0_52(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__BcTreeDictionary_527_0_53(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__BcTreeDictionary_527_0_54(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G__BcTreeDictionary_527_0_55(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
, *((TLorentzVector*) G__int(libp->para[6])), (Double_t) G__double(libp->para[7])
...
static void G__setup_memvarBcTreeCand(void) {
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector),-1,-1,4,"Bc3Pi_=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector),-1,-1,4,"Pi1_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector),-1,-1,4,"Pi2_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector),-1,-1,4,"Pi3_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector),-1,-1,4,"tPi1_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector),-1,-1,4,"tPi2_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector),-1,-1,4,"tPi3_=",0,(char*)NULL);
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector),-1,-1,4,"JpsiV_=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"Ris_[5]=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"IP3D_[3]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"IPbs_[3]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"sIP3D_[3]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"sIPbs_[3]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"MatchMu_[2]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"MatchPi1_[2]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"MatchPi2_[2]=",0,(char*)NULL);
   G__memvar_setup((void*)0,100,0,0,-1,G__defined_typename("Double_t"),-1,4,"MatchPi3_[2]=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,G__defined_typename("Int_t"),-1,4,"PiCh_[3]=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)0,105,0,0,-1,G__defined_typename("Int_t"),-1,4,"TrkNHits_[3]=",0,(char*)NULL);
   G__memvar_setup((void*)0,105,0,0,-1,G__defined_typename("Int_t"),-1,4,"TrkPixelHits_[3]=",0,(char*)NULL);
   G__memvar_setup((void*)0,102,0,0,-1,G__defined_typename("Float_t"),-1,4,"TrkChi2_[3]=",0,(char*)NULL);
...
static void G__setup_memfuncBcTreeCand(void) {
   ...
   G__memfunc_setup("BcTreeCand",939,G__BcTreeDictionary_526_0_3, 105, G__get_linked_tagnum(&G__BcTreeDictionaryLN_BcTreeCand), -1, 0, 37, 1, 1, 0, 
"u 'TLorentzVector' - 11 - Bc3Pi u 'TLorentzVector' - 11 - Mu1 "
"u 'TLorentzVector' - 11 - Mu2 u 'TLorentzVector' - 11 - Jpsi "
"u 'TLorentzVector' - 11 - Pi1 u 'TLorentzVector' - 11 - Pi2 "
"u 'TLorentzVector' - 11 - Pi3 u 'TLorentzVector' - 11 - tPi1 "
"u 'TLorentzVector' - 11 - tPi2 u 'TLorentzVector' - 11 - tPi3 "
"u 'TLorentzVector' - 11 - JpsiV D - 'Double_t' 0 - Ris "
"d - 'Double_t' 0 - El d - 'Double_t' 0 - Els "
...
"D - 'Double_t' 0 - MatchPi1 D - 'Double_t' 0 - MatchPi2 "
"D - 'Double_t' 0 - MatchPi3 I - 'Int_t' 0 - PiCh "
...
"D - 'Double_t' 0 - HltMatch", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetBc3Pi",689,G__BcTreeDictionary_526_0_4, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMu1",531,G__BcTreeDictionary_526_0_5, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMu2",532,G__BcTreeDictionary_526_0_6, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetJpsi",694,G__BcTreeDictionary_526_0_7, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPi1",522,G__BcTreeDictionary_526_0_8, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPi2",523,G__BcTreeDictionary_526_0_9, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPi3",524,G__BcTreeDictionary_526_0_10, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GettPi1",638,G__BcTreeDictionary_526_0_11, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GettPi2",639,G__BcTreeDictionary_526_0_12, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GettPi3",640,G__BcTreeDictionary_526_0_13, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetJpsiV",780,G__BcTreeDictionary_526_0_14, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 1, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetRis",590,G__BcTreeDictionary_526_0_15, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetEl",465,G__BcTreeDictionary_526_0_16, 100, -1, G__defined_typename("Double_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetEls",580,G__BcTreeDictionary_526_0_17, 100, -1, G__defined_typename("Double_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCos",581,G__BcTreeDictionary_526_0_18, 100, -1, G__defined_typename("Double_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetClS",546,G__BcTreeDictionary_526_0_19, 100, -1, G__defined_typename("Double_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetClJpsi",869,G__BcTreeDictionary_526_0_20, 100, -1, G__defined_typename("Double_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetBS",437,G__BcTreeDictionary_526_0_21, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetVtxS",693,G__BcTreeDictionary_526_0_22, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetBSCovariance",1456,G__BcTreeDictionary_526_0_23, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSVCovariance",1476,G__BcTreeDictionary_526_0_24, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetIP3D",560,G__BcTreeDictionary_526_0_25, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetIPbs",654,G__BcTreeDictionary_526_0_26, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetsIP3D",675,G__BcTreeDictionary_526_0_27, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetsIPbs",769,G__BcTreeDictionary_526_0_28, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMatchMu",975,G__BcTreeDictionary_526_0_29, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMatchPi1",1015,G__BcTreeDictionary_526_0_30, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMatchPi2",1016,G__BcTreeDictionary_526_0_31, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMatchPi3",1017,G__BcTreeDictionary_526_0_32, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPiCh",644,G__BcTreeDictionary_526_0_33, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMuCh",653,G__BcTreeDictionary_526_0_34, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetElsigJpsi",1194,G__BcTreeDictionary_526_0_35, 100, -1, G__defined_typename("Double_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCosJpsi",987,G__BcTreeDictionary_526_0_36, 100, -1, G__defined_typename("Double_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetTrkNHits",1079,G__BcTreeDictionary_526_0_37, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetTrkPixelHIts",1483,G__BcTreeDictionary_526_0_38, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetTrkChi2",919,G__BcTreeDictionary_526_0_39, 102, -1, G__defined_typename("Float_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetHltMatch",1077,G__BcTreeDictionary_526_0_40, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__BcTreeDictionary_526_0_41, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&BcTreeCand::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__BcTreeDictionary_526_0_42, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BcTreeCand::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__BcTreeDictionary_526_0_43, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&BcTreeCand::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__BcTreeDictionary_526_0_44, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&BcTreeCand::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__BcTreeDictionary_526_0_48, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__BcTreeDictionary_526_0_49, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BcTreeCand::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__BcTreeDictionary_526_0_50, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BcTreeCand::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__BcTreeDictionary_526_0_51, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BcTreeCand::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__BcTreeDictionary_526_0_52, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BcTreeCand::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~BcTreeCand", 1065, G__BcTreeDictionary_526_0_53, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BcTreeDictionary_526_0_54, (int) ('u'), G__get_linked_tagnum(&G__BcTreeDictionaryLN_BcTreeCand), -1, 1, 1, 1, 1, 0, "u 'BcTreeCand' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
static void G__setup_memfuncBcTreeGENCand(void) {
   ...
   G__memfunc_setup("SetBc3Pi",701,G__BcTreeDictionary_527_0_2, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TLorentzVector' - 0 - n", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("SetPi1",534,G__BcTreeDictionary_527_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TLorentzVector' - 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPi2",535,G__BcTreeDictionary_527_0_7, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TLorentzVector' - 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPi3",536,G__BcTreeDictionary_527_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TLorentzVector' - 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetEl",477,G__BcTreeDictionary_527_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetCos",593,G__BcTreeDictionary_527_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetBSx",569,G__BcTreeDictionary_527_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetBSy",570,G__BcTreeDictionary_527_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetBSz",571,G__BcTreeDictionary_527_0_13, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetVtxSx",825,G__BcTreeDictionary_527_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetVtxSy",826,G__BcTreeDictionary_527_0_15, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetVtxSz",827,G__BcTreeDictionary_527_0_16, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetRis0",650,G__BcTreeDictionary_527_0_17, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetRis1",651,G__BcTreeDictionary_527_0_18, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetRis2",652,G__BcTreeDictionary_527_0_19, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetRis3",653,G__BcTreeDictionary_527_0_20, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetRis4",654,G__BcTreeDictionary_527_0_21, 121, -1, -1, 0, 1, 1, 1, 0, "d - 'Double_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPiCh1",705,G__BcTreeDictionary_527_0_22, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPiCh2",706,G__BcTreeDictionary_527_0_23, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetPiCh3",707,G__BcTreeDictionary_527_0_24, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetMuCh1",714,G__BcTreeDictionary_527_0_25, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetMuCh2",715,G__BcTreeDictionary_527_0_26, 121, -1, -1, 0, 1, 1, 1, 0, "i - 'Int_t' 0 - n", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetBc3Pi",689,G__BcTreeDictionary_527_0_27, 117, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMu1",531,G__BcTreeDictionary_527_0_28, 117, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMu2",532,G__BcTreeDictionary_527_0_29, 117, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetJPsi",662,G__BcTreeDictionary_527_0_30, 117, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPi1",522,G__BcTreeDictionary_527_0_31, 117, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPi2",523,G__BcTreeDictionary_527_0_32, 117, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPi3",524,G__BcTreeDictionary_527_0_33, 117, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TLorentzVector), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetEl",465,G__BcTreeDictionary_527_0_34, 100, -1, G__defined_typename("Double_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetCos",581,G__BcTreeDictionary_527_0_35, 100, -1, G__defined_typename("Double_t"), 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetBS",437,G__BcTreeDictionary_527_0_36, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetVtxS",693,G__BcTreeDictionary_527_0_37, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetRis",590,G__BcTreeDictionary_527_0_38, 100, -1, G__defined_typename("Double_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetPiCh",644,G__BcTreeDictionary_527_0_39, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetMuCh",653,G__BcTreeDictionary_527_0_40, 105, -1, G__defined_typename("Int_t"), 0, 1, 1, 1, 0, "i - 'Int_t' 0 - Id_", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__BcTreeDictionary_527_0_41, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&BcTreeGENCand::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__BcTreeDictionary_527_0_42, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BcTreeGENCand::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__BcTreeDictionary_527_0_43, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&BcTreeGENCand::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__BcTreeDictionary_527_0_44, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&BcTreeGENCand::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - insp", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__BcTreeDictionary_527_0_48, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__BcTreeDictionary_527_0_49, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BcTreeGENCand::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__BcTreeDictionary_527_0_50, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BcTreeGENCand::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__BcTreeDictionary_527_0_51, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&BcTreeGENCand::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__BcTreeDictionary_527_0_52, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&BcTreeGENCand::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("BcTreeGENCand", 1157, G__BcTreeDictionary_527_0_53, (int) ('i'), G__get_linked_tagnum(&G__BcTreeDictionaryLN_BcTreeGENCand), -1, 0, 1, 1, 1, 0, "u 'BcTreeGENCand' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~BcTreeGENCand", 1283, G__BcTreeDictionary_527_0_54, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__BcTreeDictionary_527_0_55, (int) ('u'), G__get_linked_tagnum(&G__BcTreeDictionaryLN_BcTreeGENCand), -1, 1, 1, 1, 1, 0, "u 'BcTreeGENCand' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncBcTree(void) {
   ...
   G__memfunc_setup("GetBcTreeJpsiArrayCand",2144,G__BcTreeDictionary_530_0_6, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TClonesArray), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetBcTreeArrayCand",1738,G__BcTreeDictionary_530_0_7, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_TClonesArray), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("AddBcTreeCand",1204,G__BcTreeDictionary_530_0_14, 85, G__get_linked_tagnum(&G__BcTreeDictionaryLN_BcTreeCand), -1, 0, 37, 1, 1, 0, 
"u 'TLorentzVector' - 11 - Bc3Pi u 'TLorentzVector' - 11 - Mu1 "
"u 'TLorentzVector' - 11 - Mu2 u 'TLorentzVector' - 11 - Jpsi "
"u 'TLorentzVector' - 11 - Pi1 u 'TLorentzVector' - 11 - Pi2 "
"u 'TLorentzVector' - 11 - Pi3 u 'TLorentzVector' - 11 - tPi "
"u 'TLorentzVector' - 11 - tPi2 u 'TLorentzVector' - 11 - tPi3 "
"u 'TLorentzVector' - 11 - JpsiV D - 'Double_t' 0 - Ris "
"d - 'Double_t' 0 - El d - 'Double_t' 0 - Els "
"d - 'Double_t' 0 - Cos d - 'Double_t' 0 - ClS "
...
"I - 'Int_t' 0 - TrkPixelHits F - 'Float_t' 0 - TrkChi2 "
"D - 'Double_t' 0 - HltMatch", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetBcTreeGENCand",1457,G__BcTreeDictionary_530_0_15, 121, -1, -1, 0, 14, 1, 1, 0, 
"u 'TLorentzVector' - 0 - Bc3Pi u 'TLorentzVector' - 0 - Mu1 "
"u 'TLorentzVector' - 0 - Mu2 u 'TLorentzVector' - 0 - JPsi "
"u 'TLorentzVector' - 0 - Pi1 u 'TLorentzVector' - 0 - Pi2 "
"u 'TLorentzVector' - 0 - Pi3 d - 'Double_t' 0 - El "
"d - 'Double_t' 0 - Cos D - 'Double_t' 0 - BS "
"D - 'Double_t' 0 - VtxS D - 'Double_t' 0 - Ris "
"I - 'Int_t' 0 - PiCh I - 'Int_t' 0 - MuCh", (char*)NULL, (void*) NULL, 0);
