...
from HeavyFlavorAnalysis.BcAnalysis.parseArgv_cfi import *

# Load the necessary ancillary configuration files
from HeavyFlavorAnalysis.BcAnalysis.loadInit_cfi import *
...
if verbose == 0 :
	process.MessageLogger.cerr.FwkReport.reportEvery =  10000 # print out 10 times only overall
...
#For ReReco 
	...
	from HeavyFlavorAnalysis.BcAnalysis.dataRunList_cfi       import *
else:
	print lineno(), " "
	print lineno(), "Acquiring input MonteCarlo files list"
        from Configuration.AlCa.autoCond import autoCond
        process.GlobalTag.globaltag = autoCond['mc']
	from HeavyFlavorAnalysis.BcAnalysis.monteCarloRunList_cfi import *
...
if dataType == "data" and useJSON == 1:
	...
	from HeavyFlavorAnalysis.BcAnalysis.JSON_cfi import *
...
process.BcAnalysis = cms.EDAnalyzer('BcAnalysis',
                              inputDouble_     = cms.vstring ("cut_Pt_Mu=0",
            		        	        	      	"cut_Pt_Trk=0.9",
            		      		        	      	"cut_chi2n=3",
    	    		      		        	      	"cut_cl=0.001",#0.001 
    	    		      		        	      	"cut_cl_Jpsi=0.005",#0.01 
							      					"ptJpsi=6.9",#7
											        "elsigJpsi=3",#3
  						  					        "cosenoJpsi=0.9",#0.9							      
							      					"cut_cl_Bc=0.001",#0.004
    	    		      		        	        "cut_eta=2.4",
    	    		      		        	        "cut_eta_pi=2.4",
    	    		      		        	        "cut_nhits=6",
							      					...
							      					"pCandMomCut=0.",#1
					        	                    "numberOfValidPixelHitsCut=2"#1
					        	                     ),
                              inputString_     = cms.vstring ("filename=" + output,
							      				   "HLTname1=HLT_Dimuon7_Jpsi_Displaced_v1",
							      				   "HLTname2=HLT_Dimuon7_Jpsi_Displaced_v3",
							      				   "HLTname3=HLT_Dimuon7_Jpsi_Displaced_v3",
							      				   "trackCollection=generalTracks",
                                                   "HLTnameReference1=HLT_Dimuon0_Jpsi_v1",
                                                   "HLTnameReference2=HLT_Dimuon0_Jpsi_v3",
							      				   "HLTMatchModule1=hltDimuon7JpsiDisplacedL3Filtered",
							        			   "HLTMatchModule2=hltDisplacedmumuFilterDimuon7Jpsi",
