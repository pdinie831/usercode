...
#include "HeavyFlavorAnalysis/BcAnalysis/interface/BcAnalysis.h"
...
BcAnalysis::BcAnalysis(const edm::ParameterSet& iConfig) :
...
void BcAnalysis::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  runNumber++;
  nEvents_++;
...
//         if (DRPi > 3) continue;
   ...
   std::cout << "NumBc is " << NumBc << std::endl;
...
//===============================================================================================
void BcAnalysis::MonteCarloStudies(const edm::Event& iEvent)
{
...
//=============================================================================================================================================== 
bool BcAnalysis::passPioncuts(reco::TrackRef pionCand)
{
...
//============================================================================================== 
pair<double,double> BcAnalysis::pionImpactParameter(reco::TransientTrack piTT, TransientVertex jpsiVtx)
{
...
//============================================================================================== 
pair<double,double> BcAnalysis::pionIPBeamSpot(reco::TransientTrack piTT, GlobalPoint BsGp)
{
...
void BcAnalysis::acquireInputParameters(void)
{
   std::cout << "\n\n"
             << __LINE__ << "]\t" 
             << __PRETTY_FUNCTION__  
...
//========================================================================================
void BcAnalysis::checkHLT(const edm::Event& iEvent)
{
