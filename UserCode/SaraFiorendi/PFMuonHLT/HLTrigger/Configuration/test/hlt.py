# /users/fiorendi/MuonIsoHLT/V28 (CMSSW_5_2_8)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/fiorendi/MuonIsoHLT/V28')
)
...
process.hltPFAllChargedHadrons = cms.EDFilter("PdgIdPFCandidateSelector",
   src = cms.InputTag("hltPFPileUpIso"),
   pdgId = cms.vint32(211,-211,321,-321,999211,2212,-2212)
)
process.hltPFAllChargedParticles = cms.EDFilter("PdgIdPFCandidateSelector",
   src = cms.InputTag("hltPFNoPileUpIso"),
   pdgId = cms.vint32(211,-211,321,-321,999211,2212,-2212,11,-11,13,-13)
)
process.hltPFAllNeutralHadrons = cms.EDFilter("PdgIdPFCandidateSelector",
  src = cms.InputTag("hltPFNoPileUpIso"),
  pdgId = cms.vint32(111,130,310,2112)
)
process.hltPFAllPhotons = cms.EDFilter("PdgIdPFCandidateSelector",
    src = cms.InputTag("hltPFNoPileUpIso"),
    pdgId = cms.vint32(22)
)
process.hltPFPileUpAllChargedParticles = process.hltPFAllChargedParticles.clone( src = 'hltPFPileUpIso' )

from CommonTools.ParticleFlow.Isolation.tools_cfi import *
process.hltMuPFIsoDepositCharged    = isoDepositReplace('hltL3MuonCandidates','hltPFAllChargedHadrons')
...
process.hltPFFilterLoose = cms.EDFilter( "HLTMuonPFIsoFilter",
                            saveTags = cms.bool( True ),
...
process.hltPFFilterTight = cms.EDFilter( "HLTMuonPFIsoFilter",
                            saveTags = cms.bool( True ),
                            PreviousCandTag = cms.InputTag( "hltL3fL1sMu16Eta2p1L1f0L2f16QL3Filtered24Q" ),
                            MinN = cms.int32( 1 ),
...
process.HLTTrackReconstructionForPF = cms.Sequence( process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingSequence + process.HLTDoLocalStripSequence + process.HLTRecoJetSequencePrePF + process.HLTIterativeTracking + process.hltPFMuonMerging + process.hltMuonLinks + process.hltMuons )
...
process.HLTVerticesSequence = cms.Sequence( process.hltOnlinePrimaryVertices + process.hltGoodOnlinePVs + process.hltPFPileUp + process.hltPFNoPileUp )
...
process.HLTPFSortSequence = cms.Sequence(process.hltPFAllChargedHadrons + process.hltPFAllChargedParticles + process.hltPFAllNeutralHadrons + process.hltPFAllPhotons + process.hltPFPileUpAllChargedParticles)

process.HLTMuonPFIsolationDepositsSequence = cms.Sequence(process.hltMuPFIsoDepositCharged + process.hltMuPFIsoDepositChargedAll + process.hltMuPFIsoDepositGamma + process.hltMuPFIsoDepositNeutral + process.hltMuPFIsoDepositPU )
...
process.HLT_Mu24_eta2p1_PFIsoLoose = cms.Path( process.HLTBeginSequence + process.hltL1sMu16Eta2p1 + process.hltPreMu24eta2p1 + process.hltL1fL1sMu16Eta2p1L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16Eta2p1L1f0L2Filtered16Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16Eta2p1L1f0L2f16QL3Filtered24Q + process.HLTTrackReconstructionForPF + process.HLTParticleFlowSequence + process.HLTVerticesSequence + process.HLTPFNoPileUpIsoSequence + process.HLTPFSortSequence + process.HLTMuonPFIsolationSequence + process.hltPFFilterLoose + process.HLTEndSequence )
process.HLT_Mu24_eta2p1_PFIsoTight = cms.Path( process.HLTBeginSequence + process.hltL1sMu16Eta2p1 + process.hltPreMu24eta2p1 + process.hltL1fL1sMu16Eta2p1L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16Eta2p1L1f0L2Filtered16Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16Eta2p1L1f0L2f16QL3Filtered24Q + process.HLTTrackReconstructionForPF + process.HLTParticleFlowSequence + process.HLTVerticesSequence + process.HLTPFNoPileUpIsoSequence + process.HLTPFSortSequence + process.HLTMuonPFIsolationSequence + process.hltPFFilterTight + process.HLTEndSequence )
process.HLT_Mu24_eta2p1_v5    = cms.Path( process.HLTBeginSequence + process.hltL1sMu16Eta2p1 + process.hltPreMu24eta2p1 + process.hltL1fL1sMu16Eta2p1L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16Eta2p1L1f0L2Filtered16Q + process.HLTL3muonrecoSequence + process.hltL3fL1sMu16Eta2p1L1f0L2f16QL3Filtered24Q + process.HLTEndSequence )


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        'file:/afs/cern.ch/work/f/fiorendi/private/MuonHLT/CMSSW_5_2_9/src/MyTools/Analyzers/test/dataFiles/C059F729-D1BA-E111-B12F-002618943829.root',
        'file:/afs/cern.ch/work/f/fiorendi/private/MuonHLT/CMSSW_5_2_9/src/MyTools/Analyzers/test/dataFiles/3C54E4C4-D2BA-E111-A4C6-0026189438C0.root',
        'file:/afs/cern.ch/work/f/fiorendi/private/MuonHLT/CMSSW_5_2_9/src/MyTools/Analyzers/test/dataFiles/12E5CE09-D3BA-E111-AF17-00261894385A.root',
        'file:/afs/cern.ch/work/f/fiorendi/private/MuonHLT/CMSSW_5_2_9/src/MyTools/Analyzers/test/dataFiles/B6987D93-D4BA-E111-80AD-002618FDA265.root',
#         '/store/data/Run2012B/SingleMu/RAW/v1/000/194/533/06691E47-C8A2-E111-A9F0-003048D3756A.root',
    ),
...
process.hltOutput = cms.OutputModule( "PoolOutputModule",
                                     fileName = cms.untracked.string( "HLT_Mu24_eta2p1_PFIso_PromptSkim2012B_RAW-RECO_TestDeltaBeta.root" ),
                                     fastCloning = cms.untracked.bool( False ),
                                     outputCommands = AODEventContent.outputCommands 
                                                      + cms.untracked.vstring('keep edmTriggerResults_*_*_*') ,
                                            #          + cms.untracked.vstring('keep *_*_*_PFHLT') ,
#                                     outputCommands = AODEventContent.outputCommands + cms.untracked.vstring('keep edmTriggerResults_*_*_*') + cms.untracked.vstring('keep *_*_*_PFHLT'),
                                     )
process.Output = cms.EndPath( process.hltOutput )

process.schedule = cms.Schedule( process.HLT_Mu24_eta2p1_v5, process.HLT_Mu24_eta2p1_PFIsoLoose, process.HLT_Mu24_eta2p1_PFIsoTight, process.HLTriggerFinalPath, process.Output )
